...
export default function AdminNotFound() {
  return (
    <div className="min-h-screen bg-[#f5f7fb]">
      <AdminHeader title="Admin" subtitle="Page not found" />
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6">The admin page you’re looking for doesn’t exist. Try going back to the dashboard.</p>
                <div className="flex gap-3">
                  <Link href="/admin" className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-white font-medium hover:bg-blue-700">
