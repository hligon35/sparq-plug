...
export default function ManagerNotFound() {
  return (
    <div className="min-h-screen bg-[#f5f7fb]">
      <Header title="Manager" subtitle="Page not found" />
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6">The page you’re trying to view isn’t available. Return to the manager dashboard.</p>
                <div className="flex gap-3">
                  <Link href="/manager" className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-white font-medium hover:bg-blue-700">
