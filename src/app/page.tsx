    ...
    <main className="min-h-screen bg-[#f5f7fb] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="mx-auto w-20 h-20 bg-[#1d74d0] rounded-2xl flex items-center justify-center mb-6 shadow">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-xl p-8">
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 bg-[#1d74d0] hover:bg-[#1667bd] text-white font-semibold rounded-xl transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
